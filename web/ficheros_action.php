...
if ($_SERVER['REQUEST_METHOD'] != 'POST') {
   $errors[] = "Método de solicitud no es POST";
    ...
    if ($_FILES["archivo"]["error"] !== UPLOAD_ERR_OK) {
        $errors[] = "No se ha podido subir el archivo, es demasiado grande o erróneo";
    } else {
...
if (empty($errors)) { // Comprueba si la variable $errors está vacía
    ...
    $exists = archivoExiste($nombreArchivo, $usuario_id); // Comprueba si el usuario ya existe en la base de datos
